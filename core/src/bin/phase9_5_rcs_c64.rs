...
use ksa64_core::phase9_5_rcs::run_phase95_rcs_case;
const MAGIC: u32 = 0x3953_4352;
...
pub extern "C" fn main() -> isize {
    ...
    let mut failures = run_phase95_rcs_case(0);
    unsafe {
        put(8, 2);
    }
    failures |= run_phase95_rcs_case(1);
    unsafe {
        put(8, 3);
    }
    failures |= run_phase95_rcs_case(2);
    unsafe {
        put(8, 0x103);
    }
    finish(failures)
