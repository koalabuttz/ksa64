...
Status: numeric contract, planar dynamics, atmosphere, aerodynamics, guidance, packed scenarios, bounded staging, and nominal/failure missions accepted; Phase 2 telemetry and host validation are next.
