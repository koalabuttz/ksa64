//! Phase 10 deterministic host campaign, archive, and report primitives.

use crc32fast::Hasher;
use ksa64_core::evaluation::{EvaluationOutcome, EvaluationSummary, ModelProfileId};
use ksa64_core::phase10_contract::{
    EarthModelPack, GlobalSegment, ReferenceFrameId, TransformPack, PHASE10_CONTRACT_ID,
};
...
impl GlobalFixtureSet {
    ...
    pub fn campaign_config(&self, run_count: u16) -> GlobalCampaignConfig {
