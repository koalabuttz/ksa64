...
pub const TURBO232_COMMAND_POLLING_8N1: u8 = 0x03;
...
impl C64AciaRegisters {
    ...
    /// Resets and selects polled 8-N-1 Turbo232 enhanced 57,600 baud mode./// Caller must ensure a compatible cartridge or VICE ACIA is present.
