...
use ksa64_flight::phase11_safehold::{ksa_g10r_safehold_coast_config, SafeholdRecoveryV1};
...
const BOX_MAGIC: u32 = 0x3242_4d4b;
const RESULT_MAGIC: u32 = 0x3246_4c4b;
...
pub extern "C" fn main() -> isize {
    ...
    let mut package = SafeholdRecoveryV1::new(ksa_g10r_safehold_coast_config())
        .unwrap_or_else(|| stop(10, 0, 0, 0, 0));
    unsafe { write(6, 1) };
    let mut seen = 0u8;
    let mut epoch = 0u16;
