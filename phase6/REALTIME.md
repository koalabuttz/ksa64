...
KSA-6R is distinct from the frozen accuracy-first Phase 5/Phase 6 exact-paced profile. It uses 32 Hz control, 8 Hz navigation/sequencing/status, and 1 Hz guidance slices. Compact cells carry Q12 delta velocity and Q15 quaternion-vector attitude observations. Commands become effective in the following fast epoch.
...
|---|---:|---:|---|
| ordinary 32 Hz | 12,481 | 24,631 | pass |
| worst 8 Hz release | 23,771 | 24,631 | pass |

The projected flight-computer CPU demand is 197.14 seconds over a 396.625-second mission, or about 49.7% average utilization. The 6,947-byte probe remains well below the stock-memory boundary.
