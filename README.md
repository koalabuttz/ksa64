...
- the Phase 12B.5 portable session and `no_std + alloc` KPS1 presentation crates, strict Rust-owned KSB11 replay, portable ABI-v1 libraries, loopback PWA broker, Noise-paired native/Vita LAN, compact React/Babylon Mission Control PWA, byte-exact single-worker Rust/WASM authority, and a bounded Vita/SDL2 VPK; hosted cross-platform and physical-device qualification remain explicitly pending.
...
|---|---|
| 12B.5 — Platform foundation | **Software-complete; qualification pending:** portable session/KPS1 authority, cross-platform bridge and packaging, secure broker, React/Babylon PWA with exact Rust/WASM authority, and Vita/SDL2 are implemented; hosted platform and required physical-device evidence remain open. |
