...
| 12C — Global engineering viewer | Renderer-neutral Earth-scale 3-D visualization through desktop Unreal and a WebGPU/WebGL browser lane, with exact ENU/ECEF/GCRF display domains, events, entry, and recovery. |
